...
?>
    ...
    <body>
        ...
        <!-- fifth Container -->
        <div class="container-fluid bg-3 text-center">
            <h3 class="margin"><b>DATA PRODUK INOVASI</b></h3>
            <br />
            <div class="container">
                <br />
        ...
        <div class="container-fluid bg-2 text-center">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <p>
                        Jamu di Indonesia biasa digunakan sebagai obat herbal atau hasil meramu bahan-bahan yang berasal dari alam dan memiliki khas...<a href="">Selengkapnya</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Membuat Function Menggunakan Ajax
                    ...
                    success: function(data) {
                        ...
                        if (data.length > 0) {
                            for (var count = 0; count < data.length; count++) {
                                html += '<tr>';
                                html += '<td>' + data[count].nama_produk + '</td>';
                                html += '<td>' + data[count].harga_produk + '</td>';
                                html += '<td>' + data[count].jenis_produk + '</td>';
                            }
                        } else {
